...
# v3.0 vector strings, base scores, and base severities for each
...
DST_PATH = File.join(__dir__, 'v30-scores.json.gz')
...
# map vulnerabilities to unique cvss v3.0 vector, score, and severity
ROWS = VULNS.each_with_object([]) do |v, r|
  ms = (v['cve']['metrics']['cvssMetricV30'] || [])
